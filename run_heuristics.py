#usage python run_heuristics.py >> supplemental_data/multiprocess_heuristics_log.txt 2>&1
...
influx_command = "python final_heuristics.py "
log = " >> "
log_post = " 2>&1 "
...
#Create list of commands to pass to the multiprocessing manager
    ...
    with open (input_file,'rb') as f:
        ...
        for row in reader:
            ...
            log_file = far_filename + '.log'          

            command = influx_command + far_filename + ' ' + near_filename + log + log_file + log_post
